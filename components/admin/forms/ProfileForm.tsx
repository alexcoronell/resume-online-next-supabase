  ...
  return (
    <div className={styles.FormContainer}>
      ...
      <div className={styles.FormContainer__box}>
        <form
          className="mx-auto w-full max-w-[650px] gap-3 md:grid md:grid-cols-2"
          onSubmit={handleSubmit}
        >
          <div className="mb-6 max-h-[300px] w-full max-w-[300px] overflow-hidden rounded-full border-2 border-primary">
            {image && (
              <Image
                src={image}
                alt={

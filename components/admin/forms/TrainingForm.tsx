  ...
  return (
    <div className={styles.FormContainer}>
      ...
      <div className={styles.FormContainer__box}>
        <form
          className="mx-auto w-full max-w-[700px] gap-x-3 px-2 lg:grid lg:max-w-[900px] lg:grid-cols-2"
        ...
        >
          ...
          <Input
            ...
            readonly={statusForm === 'details'}
          />
          <div className="gap-x-3 md:grid md:grid-cols-2 lg:col-span-2 lg:grid-cols-3">
            <InputSelect
              name="institute"
